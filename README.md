...
## Описание реализации
Я реализовал приложение, которое принимает на вход input.json, и выводит месяцы с максимальной прибылью за последний год, который находится в файле
...
5 Перейдите в папку проекта и запустите: 
