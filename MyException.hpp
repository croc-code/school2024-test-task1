...
class MyException {
	...
	int get_code(){
		return this->err_number_;
	}
	std::string get_explain(){
		return this->err_explain_;
	}
	void update_explain(std::string new_data){
		this->err_explain_=new_data+this->err_explain_;
		return;
	}
};
namespace{
    ...
    void MyException_Info(std::ostream& out,std::string separator = "\n"){
        ...
        out << "--- Methods ---" << separator;
        out << "int get_code(), std::string get_explain(), void update_explain(std::string&)" << separator;
        out << "-----------------------------------------------------------------------------------" << separator;
